...
BasicLightingDiffuse::BasicLightingDiffuse(Camera& camera) :
	m_camera{camera}
{
}

void BasicLightingDiffuse::Startup()
{
    ShaderBuilder shader_builder("src/test_progs/learn_opengl/2.lighting/");
    m_shader = shader_builder.Vert("2.1.basic_lighting.vs").Frag("2.1.basic_lighting.fs").Build("basic lighting diffuse");
...
void BasicLightingDiffuse::Shutdown()
{
...
void BasicLightingDiffuse::OnUpdate(double now, double time_step)
{
...
void BasicLightingDiffuse::ImGuiUpdate()
{
}
