...
#include "basic_lighting_specular.h"
...
BasicLightingSpecular::BasicLightingSpecular(Camera& camera) :
	m_camera{ camera }
{
}

void BasicLightingSpecular::Startup()
{
    ShaderBuilder shader_builder("src/test_progs/learn_opengl/2.lighting/");
	m_shader = shader_builder.Vert("2.2.basic_lighting.vs").Frag("2.2.basic_lighting.fs").Build("basic lighting specular");
...
void BasicLightingSpecular::Shutdown()
{
...
void BasicLightingSpecular::OnUpdate(double now, double time_step)
{
...
void BasicLightingSpecular::ImGuiUpdate()
{
}