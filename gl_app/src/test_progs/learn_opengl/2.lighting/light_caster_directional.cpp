...
#include "light_caster_directional.h"
...
// ---------------------------------------------------
unsigned int LightCasterDirectional::loadTexture(char const* path)
{
...
LightCasterDirectional::LightCasterDirectional(Camera& camera):
    m_camera(camera)
{
}

void LightCasterDirectional::Startup()
{
  ...
  // -----------------------------
    ...
    m_shader = shader_builder.Vert("5.1.light_casters.vs").Frag("5.1.light_casters.fs").Build("Light caster directional");
...
void LightCasterDirectional::Shutdown()
{
...
void LightCasterDirectional::OnUpdate(double now, double time_step)
{
...
void LightCasterDirectional::ImGuiUpdate()
{
}
