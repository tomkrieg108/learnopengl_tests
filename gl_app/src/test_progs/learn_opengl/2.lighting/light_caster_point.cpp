...
// ---------------------------------------------------
unsigned int LightCasterPoint::loadTexture(char const* path)
{
...
LightCasterPoint::LightCasterPoint(Camera& camera) :
	m_camera(camera)
{
}

void LightCasterPoint::Startup()
{
...
// -----------------------------
    ...
    m_shader = shader_builder.Vert("5.2.light_casters.vs").Frag("5.2.light_casters.fs").Build("Light caster point");
...
void LightCasterPoint::Shutdown()
{
...
void LightCasterPoint::OnUpdate(double now, double time_step)
{
...
void LightCasterPoint::ImGuiUpdate()
{
}
