...
// ---------------------------------------------------
unsigned int LightCasterSpot::loadTexture(char const* path)
{
...
LightCasterSpot::LightCasterSpot(Camera& camera) :
    m_camera(camera)
{
}

void LightCasterSpot::Startup()
{
...
// -----------------------------
    ...
    m_shader = shader_builder.Vert("5.3.light_casters.vs").Frag("5.3.light_casters.fs").Build("Light caster spot");
...
void LightCasterSpot::OnUpdate(double now, double time_step)
{
...
void LightCasterSpot::ImGuiUpdate()
{
}
