...
#include "light_caster_spot_soft.h"
...
// ---------------------------------------------------
unsigned int LightCasterSpotSoft::loadTexture(char const* path)
{
...
LightCasterSpotSoft::LightCasterSpotSoft(Camera& camera) :
	m_camera(camera)
{
}

void LightCasterSpotSoft::Startup()
{
...
// -----------------------------
    ...
    m_shader = shader_builder.Vert("5.4.light_casters.vs").Frag("5.4.light_casters.fs").Build("Light caster spot soft");
...
void LightCasterSpotSoft::Shutdown()
{
...
void LightCasterSpotSoft::OnUpdate(double now, double time_step)
{
...
void LightCasterSpotSoft::ImGuiUpdate()
{
}
