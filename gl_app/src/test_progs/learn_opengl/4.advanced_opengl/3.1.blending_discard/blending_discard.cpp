...
// ---------------------------------------------------
unsigned int BlendingDiscardTest::loadTexture(char const* path)
{
...
BlendingDiscardTest::BlendingDiscardTest(Camera& camera) :
	m_camera{camera}
{
}

void BlendingDiscardTest::Startup()
{
  ...
  // -------------------------
    ShaderBuilder shader_builder("src/test_progs/learn_opengl/4.advanced_opengl/3.1.blending_discard/");
    m_shader = shader_builder.Vert("3.1.blending.vs").Frag("3.1.blending.fs").Build("Blending Discard Test");
...
void BlendingDiscardTest::Shutdown()
{
...
void BlendingDiscardTest::OnUpdate(double now, double time_step)
{
    m_shader->Bind();
...
void BlendingDiscardTest::ImGuiUpdate()
{
}
