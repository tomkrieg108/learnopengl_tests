...
// ---------------------------------------------------
unsigned int ShadowMappingBase::loadTexture(char const* path)
{
...
ShadowMappingBase::ShadowMappingBase(Window& window, Camera& camera) :
    m_window{ window }, m_camera{ camera }
{
}

void ShadowMappingBase::Startup()
{
 ...
 // -----------------------------
    ...
    // -------------------------
    ShaderBuilder shader_builder("src/test_progs/learn_opengl/5.advanced_lighting/3.1.2.shadow_mapping_base/");
    m_shader = shader_builder.Vert("3.1.2.shadow_mapping.vs").Frag("3.1.2.shadow_mapping.fs").Build("Shader mapping shader");
    simpleDepthShader = shader_builder.Vert("3.1.2.shadow_mapping_depth.vs").Frag("3.1.2.shadow_mapping_depth.fs").Build("Simple depth shader");
    debugDepthQuad = shader_builder.Vert("3.1.2.debug_quad.vs").Frag("3.1.2.debug_quad_depth.fs").Build("Debug depth quad");
...
void ShadowMappingBase::Shutdown()
{
    glDeleteVertexArrays(1, &planeVAO);
    glDeleteBuffers(1, &planeVBO);
}

void ShadowMappingBase::OnUpdate(double now, double time_step)
{
...
void ShadowMappingBase::ImGuiUpdate()
{
