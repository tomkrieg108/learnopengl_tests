...
ShadowMapping::ShadowMapping(Window& window, Camera& camera) :
    m_window{ window }, m_camera{ camera }
{
}

void ShadowMapping::Startup()
{
...
void ShadowMapping::OnUpdate(double now, double time_step)
{
...
void ShadowMapping::ImGuiUpdate()
{
