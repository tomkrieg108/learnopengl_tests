...
// ---------------------------------------------------
unsigned int PointShadows::loadTexture(char const* path)
{
...
PointShadows::PointShadows(Window& window, Camera& camera) :
	m_window{ window }, m_camera{ camera }
{
}

void PointShadows::Startup()
{
...
void PointShadows::Shutdown()
{
}

void PointShadows::OnUpdate(double now, double time_step)
{
