...
// ---------------------------------------------------
unsigned int NormalMap::loadTexture(char const* path)
{
...
NormalMap::NormalMap(Window& window, Camera& camera) :
    m_window{window}, m_camera{camera}
{
}

void NormalMap::Startup()
{
   ...
   // -----------------------------
    ...
    // -------------------------
    ShaderBuilder shader_builder("src/test_progs/learn_opengl/5.advanced_lighting/4.normal_mapping/");
    m_shader = shader_builder.Vert("4.normal_mapping.vs").Frag("4.normal_mapping.fs").Build("Normal mapping shader");

    // load textures
    // -------------
    diffuseMap = loadTexture("assets/textures/brickwall.jpg");
    normalMap = loadTexture("assets/textures/brickwall_normal.jpg");
...
void NormalMap::Shutdown()
{
}

void NormalMap::OnUpdate(double now, double time_step)
{
    m_shader->Bind();
