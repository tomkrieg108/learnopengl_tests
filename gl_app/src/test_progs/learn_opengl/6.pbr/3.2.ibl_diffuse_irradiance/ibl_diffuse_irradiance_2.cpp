...
#include "ibl_diffuse_irradiance_2.h"
...
IblDiffuseIrradiance2::IblDiffuseIrradiance2(Window& window, v2::Camera& camera) :
...
void IblDiffuseIrradiance2::Startup()
{
  glEnable(GL_DEPTH_TEST);
  glDepthFunc(GL_LEQUAL); // set depth function to less than AND equal for skybox depth trick.

  ShaderBuilder shader_builder("src/test_progs/learn_opengl/6.pbr/3.2.ibl_diffuse_irradiance/");
...
void IblDiffuseIrradiance2::Shutdown()
{
  glfwTerminate();
}

void IblDiffuseIrradiance2::OnUpdate(double now, double time_step)
{
...
void IblDiffuseIrradiance2::ImGuiUpdate()
{
}

void IblDiffuseIrradiance2::CheckKeys(double delta_time)
{
...
void IblDiffuseIrradiance2::OnEvent(Event& event)
{
...
void IblDiffuseIrradiance2::renderSphere()
{
  if (sphereVAO == 0)
  {
...
void IblDiffuseIrradiance2::renderCube()
{
...
unsigned int IblDiffuseIrradiance2::loadTexture(char const* path)
{
	return 0;
}
